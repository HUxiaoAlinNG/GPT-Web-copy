  ...
  return (
    <>
      ...
      <List>
        ...
        <ListItem
          title={Locale.Role.Config.HideContext.Title}
          subTitle={Locale.Role.Config.HideContext.SubTitle}
        >
          <input
            type="checkbox"
        ...
        {props.shouldSyncFromGlobal ? (
          <ListItem
            title={Locale.Role.Config.Sync.Title}
            subTitle={Locale.Role.Config.Sync.SubTitle}
          >
            <input
              type="checkbox"
              ...
              onChange={(e) => {
                if (
                  ...
                  confirm(Locale.Role.Config.Sync.Confirm)
                ) {
                  props.updateMask((mask) => {
